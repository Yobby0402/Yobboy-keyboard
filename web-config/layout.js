...
export function defaultLayout() {
  const rows = [
    [
      ...
      ["F5", 43, 5, 0], ["F6", 42, 6, 0], ["F7", 41, 7, 0], ["F8", 36, 8, 0],
      ["F9", 35, 9, 0], ["F10", 34, 10, 0], ["F11", 33, 11, 0], ["F12", 27, 12, 0],
      ["Ins", 25, 13, 0], ["Del", 32, 14, 0],
    ],
    [
      ...
      ["=", 28, 12, 1.25], ["Fn", 26, 13, 1.25], ["Bksp", 31, 14, 1.25],
    ],
    [
    ...
    [
      ["Ctrl", 3, 0, 6.25], ["Win", 2, 1, 6.25], ["Alt", 1, 2, 6.25],
      ["Space", 4, 3, 6.25, 7], ["Alt", 14, 10, 6.25], ["Ctrl", 13, 11, 6.25],
      ["Left", 21, 12, 6.25], ["Down", 22, 13, 6.25], ["Right", 23, 14, 6.25],
    ],
  ];
